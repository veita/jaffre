/* $Id: Server.java 394 2009-03-21 20:28:26Z  $
 *
...
public class Server
{
	...
	private void _run(String p_strBindAddress, int p_iPort, int p_iNumThreads)
	{
		try
		{
			...
			l_connector.setKeyStore("src/samples/secureClientServer/keystore");
			l_connector.setKeyStoreType("JCEKS");
			l_connector.setKeyStorePassword("secret");
			l_connector.setTrustStore("src/samples/secureClientServer/truststore");
	...
	public static void main(String[] p_args)
	{
		...
		{
			System.err.println(
				"USAGE: org.example.securecs.Server" +
